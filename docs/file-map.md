...
| `src/components/CleanTrackingParams.tsx` | Strips `utm_*`/click-id query params from the address bar after load | Tracking-parameter handling changes | Functional query parameters |
